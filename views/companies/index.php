    ...
    <div class="tab-pane fade active show" id="tab-general2" role="tabpanel" aria-labelledby="tab-general-link2">
        ...
        <form action="api/index.php?m=company&a=update" method="post">
            ...
            <div class="card-header bg-light-gray">
                ...
                <button type="submit" class="btn btn-success float-right" style="margin-right:6px;">บันทึกการตั้งค่า</a>
            </div>
...
<?php Debug($comp);  ?>
                <div class="row">
                    <div class="col-2">
                        ...
                        <span class="btn-block btn btn-primary" style="margin-top:6px;">อัพโหลด เครื่องหมายการค้า</span>
                    </div>
                    <div class="col">
                        ...
                        <div class="row" id="corporate">
                            <div class="col-sm">
                                <label>Company</label>
                                <input type="text" name="company_en" class="form-control" value="<?php echo $company_english; ?>" required="">
                                <div class="valid-feedback">ผ่าน</div>
                                <div class="invalid-feedback">Please fill out this field.</div>
                            </div>
                            <div class="col-sm">
                                <label>บริษัท</label>
                                <input type="text" name="company_th" class="form-control" value="<?php echo $company_thai; ?>" required="">
                                <div class="valid-feedback">ผ่าน</div>
                                <div class="invalid-feedback">Please fill out this field.</div>
                            </div>
                        </div>
                        <div class="row" >
                            <div class="col-sm">
                                ...
                                <textarea  name="description" class="form-control" required="" rows="5" contenteditable>บริษัท ฟอร์ซ เครน จำกัด  ดำเนินธุรกิจเกี่ยวกับ การผลิต, ติดตั้ง เครนไฟฟ้า โครงสร้างเครน พร้อมติดตั้ง และ ออกแบบ ด้วย
...
นอกจากนี้เรายังจำหน่ายสินค้าหลายอย่าง เช่น รอกสลิงไฟฟ้า, รอกโซ่ไฟฟ้า, เครนไฟฟ้า, C-Track System, Conductor Rail, Overload Protector, สายไฟ และ อุปกรณ์ในการประกอบเครน ต่างๆ
                ...
                <div class="form-row">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" name="workphone" placeholder="0-0000-0000" value="<?php echo $workphone; ?>"
                            class="form-control ">
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
